(function() {
    ...
    .factory('nzTour', ["$q", "$rootScope", "$compile", "$timeout", "$document", function($q, $rootScope, $compile, $timeout, $document) {
    ...
    .directive('nzTour', ["$q", "$compile", "$document", "$timeout", "$window", function($q, $compile, $document, $timeout, $window) {
        return {
            template: [
